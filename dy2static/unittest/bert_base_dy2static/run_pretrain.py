...
def parse_args():
    ...
    parser.add_argument(
        ...
        required=True,
        help="If set True, will use @to_static to training. default False",
    )
    parser.add_argument(
        "--model_type",
        default=None,
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for f_id in range(f_start_id, len(files)):
            ...
            for step, batch in enumerate(train_data_loader):
                ...
                input_ids = paddle.to_tensor(input_ids, place=place)
                segment_ids = paddle.to_tensor(segment_ids, place=place)
                input_mask = paddle.to_tensor(input_mask, place=place)
                masked_lm_positions = paddle.to_tensor(masked_lm_positions, place=place)
